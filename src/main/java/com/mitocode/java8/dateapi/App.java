package com.mitocode.java8.dateapi;
...
public class App {
    ...
    public void periodoEntreFechas(int version) {
        if (version == 7) {
            ...
            nacimiento.set(1985, 2, 7);
            actual.set(2020, 4, 10);
            ...
            LocalDate nacimiento = LocalDate.of(1985, 3, 7);
            ...
            System.out.println("Han transcurrido " + periodo.getYears() + " años " + periodo.getMonths()
                    + " meses " + periodo.getDays() + " dias, desde " + nacimiento + " hasta " + actual);
        }
